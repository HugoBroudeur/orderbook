...
pub fn setup(self: *ClayManager) !void {
    const key = try self.font_manager.addFont(FontManager.MainFont, 18);
...
pub fn renderCommands(
    ...
    for (cmds) |cmd| {
        ...
        switch (cmd.command_type) {
            ...
            // },
            .scissor_start => {
                // const bounding = cmd.bounding_box;
                current_clipping_rectangle = rect.asOtherRect(i32);
            ...
            .image => {
                ...
                sdl.log.log("Unknown render command type: {}", .{cmd.command_type}) catch {};
            },
        }
    }
}
