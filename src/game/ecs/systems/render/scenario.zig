...
// pub const ScenarioRenderSystem = struct {
//     const Self = @This();
//
//     camera: *data.PerspectiveCamera = undefined,
//     render_pass: delil_pass.RenderPass = undefined,
//
//     pub fn create() ScenarioRenderSystem {
//         return .{
//             // .render_pass = RenderPass.init("scenario"),
//         };
//     }
//
//     pub fn system(self: *ScenarioRenderSystem) System {
//         return .{
//             .ptr = self,
//             .vtable = &.{
//                 .onSetup = onSetup,
...
//         const self: *ScenarioRenderSystem = @ptrCast(@alignCast(ctx));
//         _ = reg;
//         _ = &self;
//
//         // self.render_pass = delil_pass.init("scenario");
//         std.log.debug("{}", .{self});
//     }
//
//     // fn onRender(ctx: *anyopaque, reg: *zecs.Registry, previous_pass: *delil_pass.RenderPass) *delil_pass.RenderPass {
//     fn onRender(ctx: *anyopaque, reg: *zecs.Registry) void {
//         const self: *ScenarioRenderSystem = @ptrCast(@alignCast(ctx));
//         // _ = &previous_pass;
//
...
//
//         sg.beginPass(game.gfx.passes[0].pass);
//         // sg.beginPass(self.render_pass.pass);
